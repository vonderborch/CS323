/*
 * Component: Enemies - RandomDirectionSpeed Enemy
 * Version: 1.0.6
...
{
    class RandomDirectionSpeedEnemy : Enemy
    {
        public RandomDirectionSpeedEnemy(Vector2 baseRenderPos, float nSpeed, float rscale, Color baseColor, int diff)
        {
            ...
            this.weapon = BarrageEngine.Weapons.Weapon.WeaponType.randomdirectionspeed;
