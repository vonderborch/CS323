/*
 * Component: Enemies - RandomSpeed Enemy
 * Version: 1.0.6
...
{
    class RandomSpeedEnemy : Enemy
    {
        public RandomSpeedEnemy(Vector2 baseRenderPos, float nSpeed, float rscale, Color baseColor, int diff)
        {
            ...
            this.weapon = BarrageEngine.Weapons.Weapon.WeaponType.randomspeed;
