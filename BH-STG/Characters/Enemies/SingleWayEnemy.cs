/*
 * Component: Enemies - SingleWay Enemy
 * Version: 1.0.6
...
{
    class SingleWayEnemy : Enemy
    {
        public SingleWayEnemy(Vector2 baseRenderPos, float nSpeed, float rscale, Color baseColor, int diff)
        {
