/*
 * Component: Enemies - DoubleWay Enemy
 * Version: 1.0.6
...
{
    class DoubleWayEnemy : Enemy
    {
        public DoubleWayEnemy(Vector2 baseRenderPos, float nSpeed, float rscale, Color baseColor, int diff)
        {
