/*
 * Component: Players - Jacob Character
 * Version: 1.0.3
...
{
    class JacobCharacter : Player
    {
        public JacobCharacter(Vector2 baseRenderPos, float rscale, Color baseColor, bool menu = false)
        {
