/*
 * Component: Players - Laser Character
 * Version: 1.0.4
...
{
    class LaserCharacter : Player
    {
        public LaserCharacter(Vector2 baseRenderPos, float rscale, Color baseColor, bool menu = false)
        {
