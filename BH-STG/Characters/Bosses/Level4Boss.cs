...
namespace BH_STG.Characters.Bosses
{
    ...
    {
        public Level4Boss(Vector2 baseRenderPos, float nSpeed, float rscale, Color baseColor, int diff)
        {
            ...
            this.weapons.Add(BarrageEngine.Weapons.Weapon.WeaponType.randomdirection);
            // Add weapons like this line.
