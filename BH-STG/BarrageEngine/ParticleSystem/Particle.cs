/*
 * Component: Particle System - Particle
 * Version: 1.0.1
...
namespace BH_STG.BarrageEngine.ParticleSystem
{
    public class Particle
    {
        ...
        public void Initialize(Vector2 position, Vector2 velocity, Vector2 acceleration,
            float lifetime, float scale, float rotationSpeed, Random rand, Main nGame)
        {
            ...
            this.Rotation = (float)rand.NextDouble() * (MathHelper.TwoPi);
        }
