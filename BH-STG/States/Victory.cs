...
{
    class Victory : BH_STG.BarrageEngine.Screen.Menu
    {
        ...
        {
            this.thisState = Main.GameStates.victory;
        ...
        public bool draw(SpriteBatch spriteBatch, Main main)
        {
            ...
            // Draw program title
            spriteBatch.DrawString(this.titleFont, "BH-STG: Victory!", new Vector2(main.videosettings.returnModifiedX(10),
