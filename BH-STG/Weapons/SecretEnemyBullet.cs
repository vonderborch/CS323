/*
 * Component: Weapon - Secret Enemy Weapon
 * Version: 1.0.5
...
{
    class SecretEnemyBullet : Weapon
    {
        Vector2 Move = new Vector2(0,0);

        public SecretEnemyBullet(Main gamemain, Color tint, Vector2 basePosition, Random random,
                                 bool isFlipped, bool isPlayerFired = false)
        {
            ...
            this.radius = 8;
            this.type = WeaponType.secretenemy;
            this.speed = new Vector2(0, 3.0f);
            this.name = "Secret Enemy Weapon";
            this.description = "The enemy's secret weapon.";
        }
